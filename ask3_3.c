	...
	if(fiq & (1<<TC0_ID))
	{
		...
		if(clock_state == CLOCK_IDLE)
		{
			...
			if(count_one_second == 4)
			{
				...
				pioa->CODR = 0xFF;
				pioa->SODR = display_decode(2);
				//display_decode(segment1+(segment2<<4));
			}
		}
		else if(clock_state == CLOCK_HOLD)
		{
...
int display_decode(int val)
{
	int rval;
	switch (val) {
		case 0: rval = 0x7e; break;
		case 1: rval = 0x30; break;
		case 2: rval = 0x6d; break;
		case 3: rval = 0x79; break;
		case 4: rval = 0x33; break;
		case 5: rval = 0x5b; break;
		case 6: rval = 0x5f; break;
		case 7: rval = 0x70; break;
		case 8: rval = 0x7f; break;
		case 9: rval = 0x7b; break;
		default: rval = 0x00; break;
	} 
	return rval;
